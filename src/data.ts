...
export const TIMELINE: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: {
      ru: 'Платформа для репетиторов: интерактивные доски (tldraw), расписание, видеосвязь (LiveKit). Hono + tRPC + TanStack. Интегрировал видеосвязь на LiveKit и настроил авторизацию через Better Auth с привязкой Telegram.',
      en: 'Tutor platform: interactive whiteboards (tldraw), scheduling, video calls (LiveKit). Hono + tRPC + TanStack. Integrated LiveKit video and Better Auth with Telegram binding.',
    },
